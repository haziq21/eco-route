...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-2687d49b.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-2687d49b.js", assets + "/_app/chunks/vendor-ba6e0429.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "global.css", "size": 1237, "type": "text/css" }, { "file": "icons/icons-192.png", "size": 5026, "type": "image/png" }, { "file": "icons/icons-512.png", "size": 9638, "type": "image/png" }, { "file": "manifest.json", "size": 494, "type": "application/json" }, { "file": "sw.js", "size": 0, "type": "application/javascript" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-a4348498.js", "css": ["assets/pages/__layout.svelte-e97bfc2f.css", "assets/Searchbar-cf5c401e.css", "assets/RouteTimeline-1c724ad4.css"], "js": ["pages/__layout.svelte-a4348498.js", "chunks/vendor-ba6e0429.js", "chunks/Searchbar-0e7def4f.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-1c755569.js", "chunks/RouteTimeline-f6af81df.js", "chunks/_stores-027b8861.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-c5c452e1.js", "css": [], "js": ["error.svelte-c5c452e1.js", "chunks/vendor-ba6e0429.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-42667d05.js", "css": ["assets/pages/index.svelte-21e0873f.css", "assets/Box-3aa18add.css", "assets/Searchbar-cf5c401e.css"], "js": ["pages/index.svelte-42667d05.js", "chunks/vendor-ba6e0429.js", "chunks/Box-53f6f880.js", "chunks/Searchbar-0e7def4f.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-1c755569.js", "chunks/_stores-027b8861.js"], "styles": [] }, "src/routes/suggested-routes.svelte": { "entry": "pages/suggested-routes.svelte-2568453e.js", "css": ["assets/pages/suggested-routes.svelte-85ea5e7d.css", "assets/Box-3aa18add.css", "assets/RouteTimeline-1c724ad4.css"], "js": ["pages/suggested-routes.svelte-2568453e.js", "chunks/vendor-ba6e0429.js", "chunks/Box-53f6f880.js", "chunks/RouteTimeline-f6af81df.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/_stores-027b8861.js", "chunks/stores-1c755569.js"], "styles": [] }, "src/routes/ringing-alarm.svelte": { "entry": "pages/ringing-alarm.svelte-265ed46f.js", "css": ["assets/pages/ringing-alarm.svelte-f2a4fed4.css"], "js": ["pages/ringing-alarm.svelte-265ed46f.js", "chunks/vendor-ba6e0429.js"], "styles": [] }, "src/routes/route-details.svelte": { "entry": "pages/route-details.svelte-2bb59343.js", "css": ["assets/pages/route-details.svelte-6e05c1a3.css", "assets/Box-3aa18add.css"], "js": ["pages/route-details.svelte-2bb59343.js", "chunks/vendor-ba6e0429.js", "chunks/Box-53f6f880.js", "chunks/_stores-027b8861.js"], "styles": [] }, "src/routes/select-[endpoint].svelte": { "entry": "pages/select-[endpoint].svelte-e25aceb5.js", "css": ["assets/pages/select-[endpoint].svelte-10dc8d04.css", "assets/Box-3aa18add.css"], "js": ["pages/select-[endpoint].svelte-e25aceb5.js", "chunks/vendor-ba6e0429.js", "chunks/stores-1c755569.js", "chunks/Box-53f6f880.js", "chunks/_stores-027b8861.js"], "styles": [] } };
...
var RouteTimeline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="${["route svelte-n9doze", $page.path === "/route-details" ? "thicker" : ""].join(" ").trim()}" style="${"width: " + escape2(route.distance / longestRoute * 100) + "%"}">${each(route.segments, (segment) => `
		${segment.distance / route.distance * parentWidth >= 5 ? `<div class="${[
    "segment " + escape2(segment.mode) + " " + escape2(segment.modeIdentity) + " svelte-n9doze",
    $page.path === "/route-details" ? "border" : ""
  ].join(" ").trim()}" style="${"width: " + escape2(segment.distance / route.distance * 100) + "%"}"><span class="${"label svelte-n9doze"}">${escape2(segment.modeIdentity || "walk")}</span>
			</div>` : ``}`)}
</div>`;
});
var css$8 = {
...
${$page.path !== "/ringing-alarm" ? `<div class="${"box svelte-1hmhp9q"}">
...
var css$6 = {
  code: ".box.svelte-xkautq{background-color:var(--overlay);color:var(--text);box-shadow:var(--shadow);border-radius:var(--border-radius);padding:var(--space);margin-bottom:var(--space);overflow:hidden}",
  map: '{"version":3,"file":"Box.svelte","sources":["Box.svelte"],"sourcesContent":["<script>\\n\\texport let title = undefined;\\n<\/script>\\n\\n<div class=\\"box\\">\\n\\t{#if title}\\n\\t\\t<h1>{title}</h1>\\n\\t{/if}\\n\\t<slot />\\n</div>\\n\\n<style>\\n\\t.box {\\n\\t\\tbackground-color: var(--overlay);\\n\\t\\tcolor: var(--text);\\n\\t\\tbox-shadow: var(--shadow);\\n\\t\\tborder-radius: var(--border-radius);\\n\\t\\tpadding: var(--space);\\n\\t\\tmargin-bottom: var(--space);\\n\\t\\toverflow: hidden;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAYC,IAAI,cAAC,CAAC,AACL,gBAAgB,CAAE,IAAI,SAAS,CAAC,CAChC,KAAK,CAAE,IAAI,MAAM,CAAC,CAClB,UAAU,CAAE,IAAI,QAAQ,CAAC,CACzB,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,OAAO,CAAE,IAAI,OAAO,CAAC,CACrB,aAAa,CAAE,IAAI,OAAO,CAAC,CAC3B,QAAQ,CAAE,MAAM,AACjB,CAAC"}'
};
var Box = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"box svelte-xkautq"}">${title ? `<h1>${escape2(title)}</h1>` : ``}
	${slots.default ? slots.default({}) : ``}
</div>`;
});
var css$5 = {
  code: ".info.svelte-1o986wm{display:grid;grid-template-columns:min-content min-content;grid-template-areas:'number icons' 'time-unit icons';justify-items:center;gap:0 var(--space-sm)}.number.svelte-1o986wm{display:flex;align-items:flex-end;grid-area:number;font-weight:bolder;font-size:1.3em}.time-unit.svelte-1o986wm{grid-area:time-unit;font-size:0.9em}.icons.svelte-1o986wm{display:flex;flex-direction:column;justify-content:center;vertical-align:center;grid-area:icons}",
  map: `{"version":3,"file":"ArrivalMarker.svelte","sources":["ArrivalMarker.svelte"],"sourcesContent":["<script lang=\\"ts\\">;\\nexport let arrival;\\n<\/script>\\n\\n<span class=\\"info\\">\\n\\t<span class=\\"number\\">\\n\\t\\t{arrival.minutesToArrival}\\n\\t</span>\\n\\t<span class=\\"time-unit\\">min</span>\\n\\t<span class=\\"icons\\">\\n\\t\\t<span class=\\"material-icons\\">\\n\\t\\t\\t{{ SEA: 'person', SDA: 'group', LSD: 'groups' }[arrival.occupancy]}\\n\\t\\t</span>\\n\\t\\t<!-- <span>{arrival.type}</span> -->\\n\\t\\t<span class=\\"material-icons\\"> directions_bus </span>\\n\\t</span>\\n</span>\\n\\n<style>\\n\\t.info {\\n\\t\\t/* background-color: aqua; */\\n\\t\\tdisplay: grid;\\n\\t\\tgrid-template-columns: min-content min-content;\\n\\t\\t/* grid-template-rows: min-content min-content; */\\n\\t\\tgrid-template-areas: 'number icons' 'time-unit icons';\\n\\t\\tjustify-items: center;\\n\\n\\t\\tgap: 0 var(--space-sm);\\n\\t}\\n\\n\\t.number {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: flex-end;\\n\\t\\tgrid-area: number;\\n\\t\\tfont-weight: bolder;\\n\\t\\tfont-size: 1.3em;\\n\\t}\\n\\n\\t.time-unit {\\n\\t\\tgrid-area: time-unit;\\n\\t\\tfont-size: 0.9em;\\n\\t}\\n\\n\\t.icons {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: center;\\n\\t\\tvertical-align: center;\\n\\t\\tgrid-area: icons;\\n\\t\\t/* color: var(--icon-text); */\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAmBC,KAAK,eAAC,CAAC,AAEN,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,WAAW,CAAC,WAAW,CAE9C,mBAAmB,CAAE,cAAc,CAAC,iBAAiB,CACrD,aAAa,CAAE,MAAM,CAErB,GAAG,CAAE,CAAC,CAAC,IAAI,UAAU,CAAC,AACvB,CAAC,AAED,OAAO,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,QAAQ,CACrB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,KAAK,AACjB,CAAC,AAED,UAAU,eAAC,CAAC,AACX,SAAS,CAAE,SAAS,CACpB,SAAS,CAAE,KAAK,AACjB,CAAC,AAED,MAAM,eAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,MAAM,CACtB,SAAS,CAAE,KAAK,AAEjB,CAAC"}`
};
var ArrivalMarker = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<span class="${"info svelte-1o986wm"}"><span class="${"number svelte-1o986wm"}">${escape2(arrival.minutesToArrival)}</span>
	<span class="${"time-unit svelte-1o986wm"}">min</span>
	<span class="${"icons svelte-1o986wm"}"><span class="${"material-icons"}">${escape2({
    SEA: "person",
    SDA: "group",
    LSD: "groups"
  }[arrival.occupancy])}</span>
		
		<span class="${"material-icons"}">directions_bus </span></span>
</span>`;
});
var css$4 = {
...
var css$2 = {
  code: ".background.svelte-11tgk2w{position:absolute;top:0;left:0;width:100%;height:100%;color:var(--overlay);background-color:var(--header)}h1.svelte-11tgk2w{font-size:2.5em}.alarm-text.svelte-11tgk2w{position:absolute;width:fit-content;text-align:center;top:35%;left:50%;transform:translate(-50%, -50%)}.place.svelte-11tgk2w{font-weight:bold}a.material-icons.svelte-11tgk2w{display:flex;align-items:center;justify-content:center;position:absolute;top:70%;left:50%;transform:translate(-50%, -50%);width:80px;height:80px;border-radius:100%;color:var(--header);background-color:var(--background);font-size:4em;box-shadow:var(--shadow) inset;animation:2s infinite alternate svelte-11tgk2w-blob}@keyframes svelte-11tgk2w-blob{from{width:80px;height:80px}to{width:100px;height:100px}}",
  map: '{"version":3,"file":"ringing-alarm.svelte","sources":["ringing-alarm.svelte"],"sourcesContent":["<div class=\\"background\\">\\n\\t<span class=\\"alarm-text\\">\\n\\t\\t<h1>This is your stop</h1>\\n\\t\\t<p>Proceed to <span class=\\"place\\">Ang Mo Kio MRT Station</span></p>\\n\\t</span>\\n\\n\\t<a href=\\"/\\" class=\\"material-icons\\"> clear </a>\\n</div>\\n\\n<style>\\n\\t.background {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tcolor: var(--overlay);\\n\\t\\tbackground-color: var(--header);\\n\\t}\\n\\th1 {\\n\\t\\tfont-size: 2.5em;\\n\\t}\\n\\t.alarm-text {\\n\\t\\tposition: absolute;\\n\\t\\twidth: fit-content;\\n\\t\\ttext-align: center;\\n\\t\\ttop: 35%;\\n\\t\\tleft: 50%;\\n\\t\\ttransform: translate(-50%, -50%);\\n\\t}\\n\\n\\t.place {\\n\\t\\tfont-weight: bold;\\n\\t}\\n\\n\\ta.material-icons {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\tposition: absolute;\\n\\t\\ttop: 70%;\\n\\t\\tleft: 50%;\\n\\t\\ttransform: translate(-50%, -50%);\\n\\n\\t\\twidth: 80px;\\n\\t\\theight: 80px;\\n\\t\\tborder-radius: 100%;\\n\\t\\tcolor: var(--header);\\n\\t\\tbackground-color: var(--background);\\n\\n\\t\\tfont-size: 4em;\\n\\t\\t/* font-weight: bolder; */\\n\\t\\tbox-shadow: var(--shadow) inset;\\n\\n\\t\\tanimation: 2s infinite alternate blob;\\n\\t}\\n\\n\\t@keyframes blob {\\n\\t\\tfrom {\\n\\t\\t\\twidth: 80px;\\n\\t\\t\\theight: 80px;\\n\\t\\t}\\n\\n\\t\\tto {\\n\\t\\t\\twidth: 100px;\\n\\t\\t\\theight: 100px;\\n\\t\\t}\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAUC,WAAW,eAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,SAAS,CAAC,CACrB,gBAAgB,CAAE,IAAI,QAAQ,CAAC,AAChC,CAAC,AACD,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,KAAK,AACjB,CAAC,AACD,WAAW,eAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,WAAW,CAClB,UAAU,CAAE,MAAM,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,AACjC,CAAC,AAED,MAAM,eAAC,CAAC,AACP,WAAW,CAAE,IAAI,AAClB,CAAC,AAED,CAAC,eAAe,eAAC,CAAC,AACjB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAEhC,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,IAAI,CACnB,KAAK,CAAE,IAAI,QAAQ,CAAC,CACpB,gBAAgB,CAAE,IAAI,YAAY,CAAC,CAEnC,SAAS,CAAE,GAAG,CAEd,UAAU,CAAE,IAAI,QAAQ,CAAC,CAAC,KAAK,CAE/B,SAAS,CAAE,EAAE,CAAC,QAAQ,CAAC,SAAS,CAAC,mBAClC,CAAC,AAED,WAAW,mBAAK,CAAC,AAChB,IAAI,AAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACb,CAAC,AAED,EAAE,AAAC,CAAC,AACH,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACd,CAAC,AACF,CAAC"}'
};
var Ringing_alarm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<div class="${"background svelte-11tgk2w"}"><span class="${"alarm-text svelte-11tgk2w"}"><h1 class="${"svelte-11tgk2w"}">This is your stop</h1>
		<p>Proceed to <span class="${"place svelte-11tgk2w"}">Ang Mo Kio MRT Station</span></p></span>

	<a href="${"/"}" class="${"material-icons svelte-11tgk2w"}">clear </a>
</div>`;
});
...
var css$1 = {
  code: ".alarm-container.svelte-1d7xm77.svelte-1d7xm77{display:flex;flex-direction:row;align-items:center;position:fixed;bottom:40px;right:30px;padding:6px 18px;border-radius:var(--border-radius);color:var(--overlay);background-color:var(--header);box-shadow:var(--shadow);font-size:1em}.material-icons-outlined.svelte-1d7xm77.svelte-1d7xm77{font-size:36px;margin-right:var(--space-md);margin-left:calc(-1 * var(--space-md))}.timeline.svelte-1d7xm77.svelte-1d7xm77{display:flex;flex-direction:column;padding:var(--space) 0}.segment.svelte-1d7xm77.svelte-1d7xm77{position:relative;width:var(--space);height:100px;border-radius:3px}.transport-mode.svelte-1d7xm77.svelte-1d7xm77{position:absolute;top:50%;transform:translateY(-50%);padding-left:30px;width:max-content}.mode-label.svelte-1d7xm77.svelte-1d7xm77{color:rgba(0, 0, 0, 0.4);padding:3px 6px;margin-right:3px;border-radius:6px;font-weight:bolder}.mode-label.bus.svelte-1d7xm77.svelte-1d7xm77{color:var(--overlay)}.place.svelte-1d7xm77.svelte-1d7xm77{position:relative;height:var(--space-sm);padding-left:30px}.place.svelte-1d7xm77>.svelte-1d7xm77{position:absolute;top:0;transform:translateY(-50%);font-size:1.1em;font-weight:bolder}.walk.svelte-1d7xm77.svelte-1d7xm77{background-color:rgb(226, 226, 226)}.bus.svelte-1d7xm77.svelte-1d7xm77{background-color:rgb(45, 175, 105)}",
  map: `{"version":3,"file":"route-details.svelte","sources":["route-details.svelte"],"sourcesContent":["<script context=\\"module\\">\\n<\/script>\\n\\n<script lang=\\"ts\\">import Box from '$lib/Box.svelte';\\nimport { selectedRoute } from './_stores';\\n<\/script>\\n\\n<Box>\\n\\t<div class=\\"timeline\\">\\n\\t\\t{#each $selectedRoute.segments as segment}\\n\\t\\t\\t<div class=\\"place\\">\\n\\t\\t\\t\\t<span>{segment.startLocation}</span>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div class=\\"segment {segment.mode} {segment.modeIdentity}\\">\\n\\t\\t\\t\\t<span class=\\"transport-mode\\">\\n\\t\\t\\t\\t\\t{#if segment.mode === 'walk'}\\n\\t\\t\\t\\t\\t\\tWalk for {Math.round(segment.distance)} metres\\n\\t\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t\\t<span class=\\"mode-label {segment.mode} {segment.modeIdentity}\\"\\n\\t\\t\\t\\t\\t\\t\\t>{segment.modeIdentity}</span\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\tfor {segment.intermediateStops} stops\\n\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t({Math.round(segment.duration / 60)} min)\\n\\t\\t\\t\\t</span>\\n\\t\\t\\t</div>\\n\\t\\t{/each}\\n\\t\\t<div class=\\"place\\">\\n\\t\\t\\t<span class=\\"place-name\\">Destination</span>\\n\\t\\t</div>\\n\\t</div>\\n</Box>\\n\\n<div class=\\"alarm-container\\">\\n\\t<span class=\\"material-icons-outlined\\"> notifications </span>\\n\\t<span>Wake me up <br /> on interchanges</span>\\n</div>\\n\\n<style>\\n\\t.alarm-container {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: row;\\n\\t\\talign-items: center;\\n\\t\\tposition: fixed;\\n\\t\\tbottom: 40px;\\n\\t\\tright: 30px;\\n\\t\\tpadding: 6px 18px;\\n\\t\\tborder-radius: var(--border-radius);\\n\\t\\tcolor: var(--overlay);\\n\\t\\tbackground-color: var(--header);\\n\\t\\tbox-shadow: var(--shadow);\\n\\t\\tfont-size: 1em;\\n\\t\\t/* font-weight: bold; */\\n\\t}\\n\\n\\t.material-icons-outlined {\\n\\t\\tfont-size: 36px;\\n\\t\\tmargin-right: var(--space-md);\\n\\t\\tmargin-left: calc(-1 * var(--space-md));\\n\\t}\\n\\n\\t.timeline {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tpadding: var(--space) 0;\\n\\t}\\n\\n\\t.segment {\\n\\t\\tposition: relative;\\n\\t\\twidth: var(--space);\\n\\t\\theight: 100px;\\n\\t\\tborder-radius: 3px;\\n\\t}\\n\\n\\t.transport-mode {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 50%;\\n\\t\\ttransform: translateY(-50%);\\n\\t\\tpadding-left: 30px;\\n\\t\\twidth: max-content;\\n\\t}\\n\\n\\t.mode-label {\\n\\t\\tcolor: rgba(0, 0, 0, 0.4);\\n\\t\\tpadding: 3px 6px;\\n\\t\\tmargin-right: 3px;\\n\\t\\tborder-radius: 6px;\\n\\t\\tfont-weight: bolder;\\n\\t}\\n\\n\\t.mode-label.bus {\\n\\t\\tcolor: var(--overlay);\\n\\t}\\n\\n\\t.place {\\n\\t\\tposition: relative;\\n\\t\\theight: var(--space-sm);\\n\\t\\tpadding-left: 30px;\\n\\t}\\n\\n\\t.place > * {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\ttransform: translateY(-50%);\\n\\t\\tfont-size: 1.1em;\\n\\t\\tfont-weight: bolder;\\n\\t}\\n\\n\\t.walk {\\n\\t\\tbackground-color: rgb(226, 226, 226);\\n\\t}\\n\\n\\t.bus {\\n\\t\\tbackground-color: rgb(45, 175, 105);\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAuCC,gBAAgB,8BAAC,CAAC,AACjB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,KAAK,CAAE,IAAI,SAAS,CAAC,CACrB,gBAAgB,CAAE,IAAI,QAAQ,CAAC,CAC/B,UAAU,CAAE,IAAI,QAAQ,CAAC,CACzB,SAAS,CAAE,GAAG,AAEf,CAAC,AAED,wBAAwB,8BAAC,CAAC,AACzB,SAAS,CAAE,IAAI,CACf,YAAY,CAAE,IAAI,UAAU,CAAC,CAC7B,WAAW,CAAE,KAAK,EAAE,CAAC,CAAC,CAAC,IAAI,UAAU,CAAC,CAAC,AACxC,CAAC,AAED,SAAS,8BAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,OAAO,CAAC,CAAC,CAAC,AACxB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,OAAO,CAAC,CACnB,MAAM,CAAE,KAAK,CACb,aAAa,CAAE,GAAG,AACnB,CAAC,AAED,eAAe,8BAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,YAAY,CAAE,IAAI,CAClB,KAAK,CAAE,WAAW,AACnB,CAAC,AAED,WAAW,8BAAC,CAAC,AACZ,KAAK,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACzB,OAAO,CAAE,GAAG,CAAC,GAAG,CAChB,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,GAAG,CAClB,WAAW,CAAE,MAAM,AACpB,CAAC,AAED,WAAW,IAAI,8BAAC,CAAC,AAChB,KAAK,CAAE,IAAI,SAAS,CAAC,AACtB,CAAC,AAED,MAAM,8BAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,UAAU,CAAC,CACvB,YAAY,CAAE,IAAI,AACnB,CAAC,AAED,qBAAM,CAAG,eAAE,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,MAAM,AACpB,CAAC,AAED,KAAK,8BAAC,CAAC,AACN,gBAAgB,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AACrC,CAAC,AAED,IAAI,8BAAC,CAAC,AACL,gBAAgB,CAAE,IAAI,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AACpC,CAAC"}`
};
var Route_details = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_selectedRoute();
  return `${validate_component(Box, "Box").$$render($$result, {}, {}, {
    default: () => `<div class="${"timeline svelte-1d7xm77"}">${each($selectedRoute.segments, (segment) => `<div class="${"place svelte-1d7xm77"}"><span class="${"svelte-1d7xm77"}">${escape2(segment.startLocation)}</span></div>
			<div class="${"segment " + escape2(segment.mode) + " " + escape2(segment.modeIdentity) + " svelte-1d7xm77"}"><span class="${"transport-mode svelte-1d7xm77"}">${segment.mode === "walk" ? `Walk for ${escape2(Math.round(segment.distance))} metres` : `<span class="${"mode-label " + escape2(segment.mode) + " " + escape2(segment.modeIdentity) + " svelte-1d7xm77"}">${escape2(segment.modeIdentity)}</span>
						for ${escape2(segment.intermediateStops)} stops`}
					(${escape2(Math.round(segment.duration / 60))} min)
				</span>
			</div>`)}
		<div class="${"place svelte-1d7xm77"}"><span class="${"place-name svelte-1d7xm77"}">Destination</span></div></div>`
  })}

<div class="${"alarm-container svelte-1d7xm77"}"><span class="${"material-icons-outlined svelte-1d7xm77"}">notifications </span>
	<span>Wake me up <br> on interchanges</span>
</div>`;
});
